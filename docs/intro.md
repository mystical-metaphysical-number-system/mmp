...
As analysis dispensed the geometers, and the Renaissance minds laid content on the limits described by Galois on polynomials, the notion of the axioms — the linchpins of mathematics — departed from the physical intuitive sensibilities of the compass and square, and were watered down to paper over incommensurate nuances. Perhaps the departure would've remained permanent, for haven't we ever built upon the bitwise arithmetic of the transistor? But alas, rounding errors are exploited for major sums of money, a good deal of music is needlessly out of tune, and what were once central cruxes in mathematics, such as the quadrature of the circle, are ignored to great calamity for a lack of appreciation of the distinction between precision at iteration and exactness.
